...
//$ucast=@(int)$_POST["ucast_t"]; //potvrdenie, $ucast,
//$mazanie=@(int)$_POST["mazanie"];
$id_reg=@(int)$_POST["id_reg"];
$id_ikonka=@(int)$_POST["id_ikonka"];
$pridanie_oznamu=prikaz_sql("INSERT INTO oznam (datum, nazov, text, id_clena, id_reg, id_ikonka)
...
$id_reg=@(int)$_POST["id_reg"];
$id_ikonka=@(int)$_POST["id_ikonka"];
$oprava_oznamu=mysql_query("UPDATE oznam SET datum ='".$_POST["datum"]."', nazov = '$nazov',
                                        text = '".$_POST["oznam_t"]."', id_clena = ".$_POST["id_clena"].",
										id_reg = $id_reg, id_ikonka = $id_ikonka
										WHERE id_oznamu = ".$_POST["id_oznamu"]." LIMIT 1 "); //potvrdenie = $ucast,
