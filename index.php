...
@$navrat=prikaz_sql("SELECT nazov, title, clanok, description, clanky FROM hlavne_menu WHERE id_hlavne_menu=$zobr_clanok AND id_reg<=".jeadmin()." LIMIT 1",
                    "Základná položka (".__FILE__ ." on line ".__LINE__ .")",""); //V DB hlavne menu najdi údaje
@$navrat1=prikaz_sql("UPDATE hlavne_menu SET pocitadlo=pocitadlo+1 WHERE id_hlavne_menu=$zobr_clanok AND id_reg<=".jeadmin()." LIMIT 1",
